<template>
  <div>
    ...
    <b-collapse id="dropbox-collapse" v-model="isDropboxVisible">
      ...
      <div class="mt-4">
        <b-btn class="mt-3 mb-3" @click="openDropBox" variant="primary"><i class="fab fa-dropbox"></i> Choose files from DropBox</b-btn>
        ...
        <b-btn ref="btn-submit" v-if="selectedFiles.length > 0" @click="onSubmit" class="mt-4" variant="success" size="md">Import the selected files</b-btn>
      </div>
