<template>
  <div>
    ...
    <b-row class="mt-4">
      <b-col>
        <b-link :to="{ name: 'activity.builder.name' }">Go back</b-link>
      </b-col>
    </b-row>
    ...
    <b-form ref="form" @submit.prevent="onSubmit">
      ...
      <b-row class="mt-4">
        <b-col md="9">
          <h3 class="mt-3">Choose a picture that represents or is related to your activity</h3>
...
export default {
  ...
  computed: {
     ...
     */
    invalidFeedback () {
      return this.currentShortDescription.length === 0 ? 'You must set a description for your activity' : 'The description length should not exceed ' + this.maxNbCharacters + ' characters'
    }
  },
  watch: {
    currentShortDescription () {
