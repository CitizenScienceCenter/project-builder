<template>
  <div>
    ...
    <b-form ref="form" @submit.prevent="onSubmit">
      <b-row>
        <b-col md="9">
          <h3 class="mt-3 mb-3">We want to know all about your activity!</h3>

          <b-form-group
                  id="fieldset-what-why"
                  label="WHAT & WHY"
                  label-for="what-why"
                  description="Explain what is the purpose of your activity and why you have created it"
          ...
          <b-form-group
                  ...
                  label="WHO"
                  label-for="who"
                  description="Explain who should contribute to this activity"
