    ...
    <b-row class="mt-4 mb-4">
      <b-col md="8" offset-md="2">
        ...
        <b-list-group>
          ...
          <b-list-group-item><b>Last project</b>: {{ infos.last_project }}</b-list-group-item>
        ...
        <h4 class="mt-4">Are you sure you want to delete all the project tasks and associated task runs?</h4>
