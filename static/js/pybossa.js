...
export default (function (pybossa, $, undefined) {
  var url = 'https://pb.citizenscience.ch/'
  ...
  function _createTaskRun (answer, task) {
    ...
    return _saveTaskRun(taskrun).then(function (data) {
      return data
    })
  }
...
}(window.pybossa = window.pybossa || {}, window.$))
